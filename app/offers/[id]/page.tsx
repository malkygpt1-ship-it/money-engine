...
export default async function OfferPage({params}:{params:Promise<{id:string}>}){
 ...
 const {o,b}=offer; const ready=b.status==="ready"; const paymentLink=b.metadata?.stripe_payment_link_url as string|undefined;

...
export default async function OfferPage({params}:{params:Promise<{id:string}>}){
 ...
 const paymentLink=typeof b.metadata?.stripe_payment_link_url==="string"?b.metadata.stripe_payment_link_url:null;
